...
def convert_prompt(prompt: str, retry_times: int = 3, type: str = "t2v", image_path: str = None):
    ...
    client = OpenAI(api_key="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")
